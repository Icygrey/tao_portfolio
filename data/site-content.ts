...
export const siteContent: Record<Locale, LocaleContent> = {
  en: {
      ...
      services: [
        {
          ...
          body:
            'I build applications from interface to backend integration with an emphasis on clean system structure, scalability, and long-term maintainability.'
        },
        {
          title: 'WEB DESIGN & DEVELOPMENT',
          body:
            'I design and build web experiences that balance brand clarity, interface calmness, and implementation precision across desktop and mobile.'
        }
      ],
      ...
      items: [
        {
          ...
          summary: 'Current chapter focused on global product surfaces, internal platforms, and systems that need scale with clarity.',
        ...
        },
        {
          ...
          summary: 'Enterprise-facing work across onboarding, product delivery, and platform-oriented interface systems.',
        ...
        },
        {
          ...
          summary: 'An early phase of sharpening interface instincts through implementation, structure, and front-end craft.',
          theme: 'Foundation'
        },
        {
          period: '2021',
          ...
          location: 'Los Angeles, CA',
          summary: 'Graduate study that expanded analytical rigor and the way systems are framed, read, and reasoned through.',
        ...
        },
        {
          ...
          role: 'B.S. Economics',
          location: 'China',
          summary: 'The earlier framework: logic, incentives, and long-range thinking that still shape my way of building.',
          theme: 'Origin'
        }
      ]
    },
    ...
    footerNote: 'Built as a restrained object for software, identity, and future expansion.',
    contactLinks: [
    ...
    seo: {
      ...
      homeDescription: 'A restrained bilingual portfolio for Tao Huang, shaped like a personal brand object.',
      aboutTitle: 'About — Tao Huang',
      aboutDescription: 'A quieter timeline-led overview of Tao Huang’s path across USC, US Bank, and ByteDance / TikTok.',
      resumeTitle: 'Resume — Tao Huang',
      resumeDescription: 'Download Tao Huang’s resume and view a concise professional summary.',
      contactTitle: 'Contact — Tao Huang',
      contactDescription: 'Contact Tao Huang for thoughtful opportunities and conversations.',
      brandTitle: 'Future Label — Tao Huang',
      brandDescription: 'A holding page for Tao Huang’s future fashion design brand.'
    }
  },
  zh: {
    locale: 'zh',
      ...
      services: [
        {
          title: '全栈工程',
          body:
            '我从界面到后端集成构建应用，重点关注系统结构的清晰性、可扩展性和长期可维护性。'
        },
        {
          title: 'Web 设计与开发',
          body:
            '我设计并实现 Web 体验，在品牌表达、界面秩序和实现精度之间找到平衡，并兼顾桌面与移动端。'
        }
      ],
      footerMailLabel: '发送邮件到 THUANG0209@OUTLOOK.COM\n以进行合作',
      footerSocialLabel: '也可以在 LINKEDIN 上联系我，或通过 WHATSAPP 给我发消息',
      ...
      items: [
        {
          ...
          role: 'Frontend Software Engineer',
          location: 'San Jose, CA',
          summary: '当前阶段聚焦全球化产品界面、内部平台以及需要在规模与清晰度之间取得平衡的系统。',
          theme: '全球化系统'
        },
        {
          period: '2022 — 2024',
        ...
        },
        {
          ...
          role: 'Frontend Engineer',
          location: 'Los Angeles, CA',
          summary: '更早的阶段里，通过前端实现、结构搭建与界面表达形成基础能力。',
          theme: '基础阶段'
        },
        {
          period: '2021',
          ...
          role: 'M.S. Biostatistics',
          location: 'Los Angeles, CA',
          summary: '研究生学习强化了分析与系统思维，也改变了我理解复杂问题的方式。',
          theme: '研究生阶段'
        },
        {
          period: '2018',
          ...
          role: 'B.S. Economics',
          location: 'China',
          summary: '更早的框架来自逻辑、激励机制与长期思维，这些仍然影响我今天的构建方式。',
          theme: '起点'
        }
      ]
    },
    ...
    resume: {
      ...
      intro: '这个网站有意保持克制。更具体的范围、职责与完整履历仍然以 PDF 简历为主。',
    ...
    contact: {
      heading: '欢迎更有质量的对话。',
      intro: '如果你对这份工作方式、这个方向，或未来品牌路径感兴趣，最好的开始方式就是直接写信。',
      invitation: '先发邮件，其他都可以往后接。'
    },
    brand: {
      heading: '未来的 fashion design 品牌，已经在这里预留了位置。',
      intro: '当前 portfolio 仍然以软件身份为中心，同时为未来独立的时尚品牌保留一条干净的延伸路径。',
      futureLine: '现在它还是一则保留说明，而不是正式发布。',
      homeLabel: '未来品牌'
    },
    footerNote: '这个网站以克制的方式搭建，同时为软件身份与未来品牌延展预留空间。',
    contactLinks: [
    ...
    seo: {
      homeTitle: 'Tao Huang — Full Stack Engineer',
      homeDescription: 'Tao Huang 的双语个人作品站：克制、极简、具有个人品牌感。',
      aboutTitle: '关于 — Tao Huang',
      aboutDescription: '以时间线方式呈现 Tao Huang 在 USC、US Bank 与 ByteDance / TikTok 的职业路径。',
