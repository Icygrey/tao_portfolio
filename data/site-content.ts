...
export const siteContent: Record<Locale, LocaleContent> = {
	en: {
		...
		home: {
			eyebrow: "IAM NOT JUST A FULL-STACK ENGINEER",
			...
			works: [
				{
					...
					imageAlt: "Tao portrait",
					imageWidth: 3458,
					imageHeight: 4611,
				},
				{
					index: "(2)",
					title: "SAY HI TO MOCHI",
					subtitle: "Mochi",
					tone: "architecture",
					position: "md:ml-auto md:mr-0 md:mt-[6rem]",
					aspectRatio: "0.89",
					imageSrc: "/photos/2.jpeg",
					imageAlt: "Mochi",
					imageWidth: 850,
					imageHeight: 956,
				},
				{
					index: "(3)",
					title: "TO FEEL THE WORLD AT -40°C",
					subtitle: "Travel",
					tone: "black",
					position: "md:-mt-[8rem] md:ml-0",
					aspectRatio: "0.75",
					imageSrc: "/photos/3.jpeg",
					imageAlt: "Tao in extreme cold weather",
					imageWidth: 4284,
					imageHeight: 5712,
				},
				{
					index: "(4)",
					title: "TOP 3 DJ OF MY 2025",
					subtitle: "Music",
					tone: "violet",
					position: "md:ml-[51%] md:-mt-[4rem]",
					aspectRatio: "1.5",
					imageSrc: "/photos/4.jpeg",
					imageAlt: "Favorite DJs of 2025",
					imageWidth: 5500,
					imageHeight: 3666,
				},
			],
